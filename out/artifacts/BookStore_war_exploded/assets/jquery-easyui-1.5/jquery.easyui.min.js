...
_350(_35d,_35e);
opts.onAdd.call(_35d,_35e.title,_35e.control);
if(_35e.selected){
_360(_35d,_35e.control);
}
};
...
if(item){
item.width=_640;
var rule=this.getRule(item.control);
if(rule){
...
var _76e=_767(_76c,_76d.control!=undefined?_76d.control:_76d.id);
...
view.insertRow.call(view,_789,_78a.control,_78a.row);
_78b.push(_78a.row);
...
var row=opts.finder.getRow(_790,_791.control);
var _793=false;
_791.row=_791.row||{};
...
opts.view.updateRow.call(opts.view,_790,_791.control,_791.row);
}
};
function _795(_796){
...
var tr=opts.finder.getTr(_7ae,(_7af.control!=undefined?_7af.control:_7af.id),_7af.type);
if(!tr.length){
return;
}
